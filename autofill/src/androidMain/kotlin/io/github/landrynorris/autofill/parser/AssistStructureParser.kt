...
class AssistStructureParser {
    ...
    fun parse(structure: AssistStructure): ParsedStructure {
        ...
        val focusedRoot = structure.focusedRoot ?: return ParsedStructure()
        ...
        return ParsedStructure(
            pkg = pkg,
            passwordNode = passwordId,
            usernameNode = usernameId,
            focused = focusedId,
        )
    }
    ...
    private fun ViewNode.focusedChild(): AutofillId? {
        ...
        return children.firstNotNullOfOrNull { it.focusedChild() }
    }
    ...
    private fun ViewNode.findMatchingKeywords(keywords: List<String>): AutofillId? {
        ...
        return children.firstNotNullOfOrNull { it.findMatchingKeywords(keywords) }
    }
