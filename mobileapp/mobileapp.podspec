Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/MobileApp.framework') || Dir.empty?('build/cocoapods/framework/MobileApp.framework')
        raise "

        Kotlin framework 'MobileApp' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :mobileapp:generateDummyFramework
